...
var profilImage = document.getElementById (`profile-img`); profilImage.alt = profil.name + " " + profil.lastName + "profile photo"; profilImage.src = profil.profileImage; 
profilImage.style.width = "200px";
profilImage.style.height = "auto";


var fullName = document.getElementById (`full-name`); fullName.innerHTML= profil.name + " " + profil.lastName;
